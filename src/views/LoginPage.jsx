        ...
        <div className="bg-gray-300 h-screen flex justify-center items-center">
            <div className="bg-white h-[50%] w-[23%] space-y-3 rounded-xl shadow-2xl">
                ...
                <div className="h-[20%] text-left px-4 pd-2">
                    ...
                    <input type="text" className="bg-gray-200 w-full rounded-md h-[50%]" placeholder=" email" />
                </div>
                <div className="h-[20%] text-left px-4 pd-2">
                    <label>Password</label><br />
                    <input type="password" className="bg-gray-200 w-full rounded-md h-[50%]" placeholder=" password" />
                </div>
